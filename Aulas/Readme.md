...
- Publicar aplicações na Web (Deploy).
...
- Servir como base para frameworks modernos.
...
Também foram introduzidos conceitos como:
...
- Definição do escopo;
- Prototipação;
- Planejamento da experiência do usuário (UX);
- Validação das ideias antes da implementação.
...
Essas ferramentas permitem controlar versões do código e disponibilizar aplicações na internet.
...
1. Criar um projeto em **Vanilla JavaScript** utilizando HTML, CSS e JavaScript.
